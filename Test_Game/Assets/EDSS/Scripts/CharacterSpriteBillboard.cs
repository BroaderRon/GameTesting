    ...
    public class ActorBillboard : MonoBehaviour
    {
        ...
        private void OnWillRenderObject()
        {
            ...
            if (cameraVector.sqrMagnitude > Mathf.Epsilon)
            {
                ...
                // below is what lines the sprite up with the camera via rotation 

                //OLD Quaternion billboardRotation = Quaternion.LookRotation(-cameraVector, Vector3.up);
                
                Quaternion billboardRotation = Quaternion.Euler(Camera.main.transform.rotation.eulerAngles.x, Camera.main.transform.rotation.eulerAngles.y, Camera.main.transform.rotation.eulerAngles.z);
